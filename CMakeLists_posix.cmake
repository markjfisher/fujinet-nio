...
option(FN_ENABLE_LEGACY_TRANSPORT "Enable legacy transport stack (SIO/IWM/IEC + adapters)" OFF)
...
target_compile_definitions(fujinet-nio
    PUBLIC
        ...
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:FN_ENABLE_LEGACY_TRANSPORT>
        # ADD MORE BUILD OPTIONS AS WE DEVELOP THEM HERE
)

if(FN_ENABLE_LEGACY_TRANSPORT AND NOT (FN_BUILD_ATARI_SIO OR FN_BUILD_ATARI_PTY OR FN_BUILD_ATARI_NETSIO))
    message(FATAL_ERROR "FN_ENABLE_LEGACY_TRANSPORT=ON but no legacy transport build option is enabled (FN_BUILD_ATARI_SIO/FN_BUILD_ATARI_PTY/FN_BUILD_ATARI_NETSIO).")
endif()
...
# __TARGET_SOURCES_START__
        ...
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/legacy_network_adapter.cpp>
        ...
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/byte_based_legacy_transport.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/iwm_traits.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/iwm_transport.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/legacy_transport.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/netsio_protocol.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/packet_based_legacy_transport.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/sio_traits.cpp>
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/lib/transport/legacy/sio_transport.cpp>
        ...
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/platform/posix/iwm_bus_hardware.cpp>
        src/platform/posix/logging.cpp
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/platform/posix/netsio_bus_hardware.cpp>
        src/platform/posix/network_registry.cpp
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/platform/posix/sio_bus_hardware.cpp>
        ...
        $<$<BOOL:${FN_ENABLE_LEGACY_TRANSPORT}>:src/platform/posix/udp_channel.cpp>
