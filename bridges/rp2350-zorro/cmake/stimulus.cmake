...
set(STIMULUS_DYNAMIC_DIRECTIONS "0" CACHE STRING
    "Let the selected stimulus program own PIO output-enable direction")
...
if(NOT STIMULUS_OUTPUT_BASE MATCHES "^[0-9]+$" OR
   ...
   NOT STIMULUS_SHIFTCTRL MATCHES "^[0-9]+$" OR NOT STIMULUS_HZ MATCHES "^[1-9][0-9]*$" OR
   NOT STIMULUS_DYNAMIC_DIRECTIONS MATCHES "^[01]$")
...
target_compile_definitions(${STIMULUS_TARGET} PRIVATE STIMULUS_WORDS=${STIMULUS_WORDS}
    ...
    STIMULUS_DYNAMIC_DIRECTIONS=${STIMULUS_DYNAMIC_DIRECTIONS})
