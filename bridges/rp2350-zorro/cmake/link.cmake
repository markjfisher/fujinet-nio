set(LINK_DEFAULT_SCENARIO "0" CACHE STRING "Story 2.3 lab scenario number (0 through 9)")
set(LINK_SPI_BAUD_HZ "1000000" CACHE STRING "SPI clock for the Story 2.3 lab")
foreach(pin SCK MOSI MISO CS READY DATA_AVAILABLE)
    set(LINK_RP_${pin}_PIN "" CACHE STRING "Override RP2350 ${pin} pin for link lab")
endforeach()
...
add_executable(link_rp2350 lab/rp2350-link/main.c lab/link-common/link_protocol.c)
...
target_compile_definitions(link_rp2350 PRIVATE LINK_DEFAULT_SCENARIO=${LINK_DEFAULT_SCENARIO}
