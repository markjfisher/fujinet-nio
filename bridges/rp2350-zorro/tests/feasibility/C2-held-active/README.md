# C2-held-active: Held-active strobe
...
- Stimulus: Hold /AS low and change data.
- Expected observation: Exactly one capture per assertion.
- Prerequisites: C1 baseline; held-active stimulus and DUT observation.
