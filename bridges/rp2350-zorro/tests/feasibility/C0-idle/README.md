# C0-idle: Idle capture suppression
...
- Stimulus: /AS high while data changes.
- Expected observation: No DUT captures or IRQ activity.
- Prerequisites: W0; USB-observable RP2350 capture firmware and idle stimulus.
