# C4-repetition: Pulse and gap limits
...
- Stimulus: Reduce low pulses and high gaps independently.
- Expected observation: Correct counts above observed limits; characterize failures below.
- Prerequisites: C1 baseline; programmable timing, bounded capture and instrumentation.
