...
// NOTE:
// We intentionally do NOT share TinyUSB CDC ACM port 0 with the FujiBus Channel,
// because mixing human text and FujiBus frames would corrupt the wire protocol.
// For the minimal console implementation we use UART0.
//
// If/when we add a second CDC interface (e.g. CDC ACM port 1) in the USB descriptors,
// this transport can be switched to TinyUSB safely.
