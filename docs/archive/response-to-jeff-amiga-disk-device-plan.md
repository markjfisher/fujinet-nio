...
> **Status: ARCHIVED — superseded 2026-08-10.** The architectural agreement
> was implemented and its durable decisions now live in
> [`../driver_architecture.md`](../driver_architecture.md) and
> [`../disk_device_protocol.md`](../disk_device_protocol.md). This document is
> retained as the original cross-repository discussion artifact.
...
[`docs/disk_device_protocol.md`](../disk_device_protocol.md).
