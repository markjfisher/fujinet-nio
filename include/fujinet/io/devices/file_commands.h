...
// variable entries blob in the response (complete entries only). Bit 0: omit u64 size+mtime
// per entry in the response. Bit 1: sort by basename (full directory is collected before
// paging; sort is a copy+sort, cache order is unchanged).
